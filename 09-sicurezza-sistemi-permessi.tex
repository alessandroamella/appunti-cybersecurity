...
\usepackage{hyperref}
\hypersetup{
    pdftitle={Appunti su Sicurezza dei Sistemi e Permessi (Access Control), Linux},
    colorlinks=true,
    linkcolor=cyan,
    filecolor=magenta,
    urlcolor=green,
...
% Stile per i nodi TikZ
\tikzstyle{genericNodeStyle}=[rectangle, rounded corners, draw=white, fill=gray!20!black, text=white, minimum height=2em, minimum width=3em, text centered]
\tikzstyle{userNodeStyle}=[ellipse, draw=white, fill=blue!50!black, text=white, minimum height=2.5em, text centered]
\tikzstyle{roleNodeStyle}=[rectangle, draw=white, fill=green!50!black, text=white, minimum height=2em, minimum width=5em, text centered]
\tikzstyle{resourceNodeStyle}=[cylinder, shape border rotate=90, aspect=0.3, draw=white, fill=red!50!black, text=white, minimum height=2.5em, text centered, alias=cyl]
\tikzstyle{arrowStyle}=[->, >=latex, draw=white, thick]
\tikzstyle{labelStyle}=[text=white, font=\footnotesize]
...
\setminted{
    ...
    fontsize=\small,
    breaklines=true,
    style=monokai, % Stile di highlighting adatto per sfondo scuro
    bgcolor=black!80 % Sfondo per i blocchi minted
}
\newminted{bash}{bgcolor=black!80, textcolor=white}
\newminted{text}{bgcolor=black!80, textcolor=white}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.7, transform shape, text=white]
            \matrix[matrix of nodes, nodes={draw, white, minimum size=1.2cm, anchor=center, fill=yellow!30!black},
                    column 1/.style={nodes={fill=black!70}},
                    row 1/.style={nodes={fill=black!70}}] (matrix_acl)
            {
                 & O1 & O2 & O3 \\
            S1   & RW & RX &    \\
            S2   & R  & RWX& RW \\
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.7, transform shape, text=white]
            \matrix[matrix of nodes, nodes={draw, white, minimum size=1.2cm, anchor=center, fill=yellow!30!black},
                    column 1/.style={nodes={fill=black!70}},
                    row 1/.style={nodes={fill=black!70}}] (matrix_cap)
            {
                 & O1 & O2 & O3 \\
            S1   & RW & RX &    \\
            S2   & R  & RWX& RW \\
            ...
            \node[draw=blue, thick, inner sep=0pt, fit=(matrix_cap-2-1) (matrix_cap-2-4), label={[blue, xshift=1cm, labelStyle]Capabilities for S1}] {};
        \end{tikzpicture}
    \end{minipage}
