...
\usepackage{hyperref}
\hypersetup{
    pdftitle={Appunti su Scambio di Chiavi (Key Exchange)},
...
\usepackage{xcolor}
\definecolor{darkbg}{RGB}{20,20,20} % Un nero non assoluto per minor affaticamento
\definecolor{lighttext}{RGB}{230,230,230} % Un bianco non assoluto
\definecolor{darknodefill}{RGB}{50,50,50}
\definecolor{darkarrow}{RGB}{180,180,180}
\definecolor{highlight}{RGB}{100,180,255} % Blu chiaro per highlight
...
% Stili TikZ per diagrammi dark theme
\tikzstyle{user} = [rectangle, rounded corners, minimum width=2.5cm, minimum height=1cm, text centered, draw=lighttext, fill=darknodefill, text=lighttext, font=\sffamily]
\tikzstyle{entity} = [rectangle, minimum width=2.5cm, minimum height=1cm, text centered, draw=lighttext, fill=blue!60!darknodefill, text=lighttext, font=\sffamily]
\tikzstyle{attacker} = [ellipse, minimum width=2cm, minimum height=1cm, text centered, draw=red!80!lighttext, fill=red!40!darknodefill, text=lighttext, font=\sffamily]
\tikzstyle{authority} = [cylinder, shape border rotate=90, aspect=0.5, minimum height=1.5cm, text width=2cm, text centered, draw=lighttext, fill=green!40!darknodefill, text=lighttext, font=\sffamily]
\tikzstyle{data} = [rectangle, draw=lighttext, fill=gray!50!darknodefill, text=lighttext, font=\sffamily\footnotesize, inner sep=2pt]
\tikzstyle{arrow} = [draw=darkarrow, -{Latex[length=2mm, width=1.5mm]}, thick]
\tikzstyle{comm_arrow} = [draw=highlight, -{Latex[length=2mm, width=1.5mm]}, thick]
\tikzstyle{key_exchange_line} = [draw=highlight, <->, dashed, thick]
