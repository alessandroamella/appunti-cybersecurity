...
\graphicspath{{images/}} % Percorso per le immagini generate esternamente
\usetikzlibrary{shapes.geometric, positioning, calc, arrows.meta}

% --- Hyperlink ---
\usepackage{hyperref}
\hypersetup{
    pdftitle={Cybersecurity: Controllo degli Accessi},
    colorlinks=true,
    linkcolor=cyan,
    filecolor=magenta,      
    urlcolor=green,
...
\usepackage{xcolor}
\definecolor{darkergray}{rgb}{0.05,0.05,0.05} % Sfondo leggermente meno nero per miglior contrasto
\definecolor{lighttext}{rgb}{0.9,0.9,0.9} % Testo leggermente meno bianco
...
\setminted{
    ...
    fontsize=\small,
    breaklines=true,
    style=monokai, % Stile 'monokai' è buono per sfondi scuri
    bgcolor=black!80 % Sfondo per i blocchi minted
}
\newmintedfile[texcode]{tex}{bgcolor=black!70} % Per mostrare codice LaTeX

% Stili per TikZ dark theme
\tikzset{
    entity/.style={rectangle, rounded corners, draw=cyan, fill=black!70, text=white, minimum height=1cm, minimum width=2cm, text centered},
    arrow/.style={-Latex, draw=green, thick},
    ...
    % Stili per diagramma FD
    proc/.style={rectangle, draw=cyan, fill=black!70, text=white, minimum height=2.5cm, minimum width=1.8cm, align=center, font=\scriptsize},
    fdt/.style={rectangle, draw=cyan, fill=black!70, text=white, minimum height=3.5cm, minimum width=2.3cm, align=center, font=\scriptsize},
    fdentry/.style={rectangle, draw=white, fill=gray!50!black, text=white, minimum height=0.45cm, minimum width=2.1cm, anchor=north west, font=\tiny},
    obj/.style={ellipse, draw=green, fill=black!70, text=white, minimum width=1.8cm, minimum height=0.9cm, align=center, font=\tiny},
    hw/.style={rectangle, draw=orange, fill=black!70, text=white, minimum width=2.2cm, minimum height=0.9cm, font=\tiny, align=center},
...
\author{Basato sulle slide del Prof. [Nome Prof Cognome Prof]} % Sostituisci con il nome reale
\date{\today}
