...
\begin{tikzpicture}[node distance=2.5cm and 1.5cm, auto]
    ...
    \node[sensor_white, below left=1.2cm and 1.5cm of cloud, label={[label_white]below:IoT Nodes}] (iot_node1) {N1};
    \node[sensor_white, below right=1.2cm and 1.5cm of cloud, label={[label_white]below:IoT Nodes}] (iot_node2) {N2};
    ...
    \path[line_white] (iot_node2.west) -- (gateway.north east);
